...
// 	protoc        v3.11.4
// source: api/login/v1/greeter.proto
...
var file_api_helloworld_v1_greeter_proto_goTypes = []interface{}{
	(*HelloRequest)(nil), // 0: login.v1.HelloRequest
	(*HelloReply)(nil),   // 1: login.v1.HelloReply
}
var file_api_helloworld_v1_greeter_proto_depIdxs = []int32{
	0, // 0: login.v1.Greeter.SayHello:input_type -> login.v1.HelloRequest
	1, // 1: login.v1.Greeter.SayHello:output_type -> login.v1.HelloReply
